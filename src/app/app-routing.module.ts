...
import { ExportLloredaComponent } from './examples/export-lloreda/export-lloreda.component';
import { LlamandoExportLloredaComponent } from './examples/llamando-export-lloreda/llamando-export-lloreda.component';
...
const routes: Routes = [
  ...
  { path: 'export-lloreda', component: ExportLloredaComponent },  
  { path: 'llamando-export-lloreda', component: LlamandoExportLloredaComponent },
